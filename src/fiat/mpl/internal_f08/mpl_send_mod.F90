...
SUBROUTINE MPL_SEND_REAL4(PBUF,KDEST,KTAG,KCOMM,KMP_TYPE,KERROR,KREQUEST,CDSTRING,LDDEVICE_DATA)
...
IF(PRESENT(LDDEVICE_DATA)) THEN
  LL_ON_DEVICE = LDDEVICE_DATA
ELSE
  LL_ON_DEVICE = LMPL_ARGS_ON_DEVICE
ENDIF
...
IF (ICOUNT == 0) THEN
  ...
  ENDIF
ELSE
  !$ACC HOST_DATA USE_DEVICE(PBUF) IF(LL_ON_DEVICE)
  IF(IMP_TYPE == JP_BLOCKING_STANDARD) THEN
  ...
  ELSE
    ...
    ENDIF
  ENDIF
  !$ACC END HOST_DATA! IF(LL_ON_DEVICE)
ENDIF
...
SUBROUTINE MPL_SEND_REAL8(PBUF,KDEST,KTAG,KCOMM,KMP_TYPE,KERROR,KREQUEST,CDSTRING,LDDEVICE_DATA)
...
SUBROUTINE MPL_SEND_INT(KBUF,KDEST,KTAG,KCOMM,KMP_TYPE,KERROR,KREQUEST,CDSTRING,LDDEVICE_DATA)
...
IF (ICOUNT == 0) THEN
 IF(IMP_TYPE == JP_BLOCKING_STANDARD) THEN
  ...
  ENDIF
ELSE
  !$ACC HOST_DATA USE_DEVICE(KBUF) IF(LL_ON_DEVICE)
  IF(IMP_TYPE == JP_BLOCKING_STANDARD) THEN
...
SUBROUTINE MPL_SEND_INT2(KBUF,KDEST,KTAG,KCOMM,KMP_TYPE,KERROR,KREQUEST,CDSTRING,LDDEVICE_DATA)
...
SUBROUTINE MPL_SEND_INT8(KBUF,KDEST,KTAG,KCOMM,KMP_TYPE,KERROR,KREQUEST,CDSTRING,LDDEVICE_DATA)
...
SUBROUTINE MPL_SEND_INT_SCALAR(KINT,KDEST,KTAG,KCOMM,KMP_TYPE,KERROR,KREQUEST,CDSTRING,LDDEVICE_DATA)
...
!$ACC HOST_DATA USE_DEVICE(KINT) IF(LL_ON_DEVICE)
IF(IMP_TYPE == JP_BLOCKING_STANDARD) THEN
...
SUBROUTINE MPL_SEND_REAL42(PBUF,KDEST,KTAG,KCOMM,KMP_TYPE,KERROR,KREQUEST,CDSTRING,LDDEVICE_DATA)
...
SUBROUTINE MPL_SEND_REAL43(PBUF,KDEST,KTAG,KCOMM,KMP_TYPE,KERROR,KREQUEST,CDSTRING,LDDEVICE_DATA)
...
SUBROUTINE MPL_SEND_REAL82(PBUF,KDEST,KTAG,KCOMM,KMP_TYPE,KERROR,KREQUEST,CDSTRING,LDDEVICE_DATA)
...
SUBROUTINE MPL_SEND_REAL4_SCALAR(PBUF,KDEST,KTAG,KCOMM,KMP_TYPE,KERROR,KREQUEST,CDSTRING,LDDEVICE_DATA)
...
SUBROUTINE MPL_SEND_REAL8_SCALAR(PBUF,KDEST,KTAG,KCOMM,KMP_TYPE,KERROR,KREQUEST,CDSTRING,LDDEVICE_DATA)
...
SUBROUTINE MPL_SEND_REAL83(PBUF,KDEST,KTAG,KCOMM,KMP_TYPE,KERROR,KREQUEST,CDSTRING,LDDEVICE_DATA)
